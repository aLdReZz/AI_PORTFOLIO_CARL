          ...
          {caseStudies.items.map((cs, i) => {
            ...
            return (
              <div
                ...
                style={{ '--i': i }}
              >
                <div className="cases__thumb" onClick={() => !open && setExpanded(i)}>
                ...
                <div className="cases__body" onClick={() => setExpanded(null)}>
                  <button className="cases__close" onClick={(e) => { e.stopPropagation(); setExpanded(null) }} aria-label="Close">
                    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2">
                      <path d="M6 6l12 12M18 6L6 18" />
                    </svg>
                  </button>
                  <div className="cases__body-inner" onClick={(e) => e.stopPropagation()}>
